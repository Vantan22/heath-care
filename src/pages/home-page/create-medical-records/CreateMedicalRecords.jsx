    ...
    function EditToolbar(props) {
        ...
        const handleClick = () => {
            ...
            setRowModesModel((oldModel) => ({
                ...oldModel,
                [id]: {mode: GridRowModes.Edit, fieldToFocus: 'tenThuoc'},
            }));
        };
                ...
                <Box sx={{
                    ...
                    <Box>
                        ...
                        <Box sx={{
                            ...
                            <OutlinedInput name="biochemicalTests" {...register("biochemicalTests")}/>
                        </Box>
                        <Box sx={{
                            width: "100%",
                            padding: "10px 20px",
                            ...
                            <OutlinedInput name="imageAnalysation" {...register("imageAnalysation")}/>
                        </Box>
                        <Box sx={{
                            width: "100%",
                            padding: "10px 20px",
                            ...
                            <OutlinedInput name="currentCondition" {...register("currentCondition")}/>
                        </Box>
                        <Box sx={{
                            width: "100%",
                            padding: "10px 20px",
                            ...
                            <OutlinedInput name="diseaseProgression" {...register("diseaseProgression")}/>
                        </Box>
                        <Box sx={{
                            width: "100%",
                            padding: "10px 20px",
                            ...
                            <OutlinedInput name="notesFromDoctor" {...register("notesFromDoctor")}/>
                        </Box>
                        <Box sx={{}}>
                            <Box
                                sx={{
