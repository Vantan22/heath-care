          ...
          <Box>
            ...
            <Box sx={{
              ...
              <FormControl sx={{width: "45%"}}>
                ...
                >
                  {departments.map((value) => <MenuItem key={value.id} value={value.id}>{value.specName}</MenuItem>)}
                </Select>
              </FormControl>
            </Box>
            <Box sx={{
              ...
              <FormControl sx={{width: "45%"}}>
                ...
                >
                  {specialization.map((value) => <MenuItem key={value.id} value={value.id}>{value.fullName}</MenuItem>)}
                </Select>
              </FormControl>
            </Box>
            <Box sx={{
